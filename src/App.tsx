...
function processFileRecord(f: any): FileRecord {
            ...
            <div style={{overflowY: "auto", flex: 1, paddingRight: "6px", paddingBottom: "40px", maxWidth: "780px", margin: "0 auto", width: "100%"}}>
              ...
              <div style={{textAlign: "center", padding: "48px 20px 28px"}}>
                ...
                <div style={{display: "flex", justifyContent: "center", gap: "10px", flexWrap: "wrap", alignItems: "center"}}>
                  <span style={{padding: "5px 14px", borderRadius: "99px", background: "var(--color-primary)", color: "#fff", fontSize: "12px", fontWeight: 700}}>v2.2.1</span>
